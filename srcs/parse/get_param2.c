...
/*   Updated: 2017/03/09 17:04:59 by ifranc-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cylinder 	get_cylinder_param(char *line)
{
	...
	if (ft_strtrue(line,"<cylinder", 0) == 1  && ft_strtrue(line,"position=", 0) == 1  && \
		ft_strtrue(line,"endpos=", 0) == 1 && ft_strtrue(line,"color=", 0) == 1 && \
...
t_disc 	get_disc_param(char *line)
{
	...
	if (ft_strtrue(line,"<disk", 0) == 1  && ft_strtrue(line,"position=", 0) == 1  && \
...
t_cone 	get_cone_param(char *line)
{
	...
	if (ft_strtrue(line,"<cone", 0) == 1  && ft_strtrue(line,"position=", 0) == 1  && \
		ft_strtrue(line,"normal=", 0) == 1 && ft_strtrue(line,"color=", 0) == 1 && \
		ft_strtrue(line,"radius=", 0) == 1)
	{
