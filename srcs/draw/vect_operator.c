...
/*   Updated: 2017/03/10 17:07:04 by ifranc-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double		triangle_area(t_vect p1, t_vect p2, t_vect p3)
{
	...
	a = sqrt(pow((p2.x - p1.x), 2) + pow((p2.y - p1.x), 2) + \
			pow((p2.z - p1.z), 2));
	b = sqrt(pow((p3.x - p2.x), 2) + pow((p3.y - p2.x), 2) + \
			pow((p3.z - p2.z), 2));
	c = sqrt(pow((p3.x - p1.x), 2) + pow((p3.y - p1.x), 2) + \
			pow((p3.z - p1.z), 2));
	s = (a + b + c) / 2;
